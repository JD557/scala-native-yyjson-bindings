...
yyjson_val* __sn_wrap_lib_yyjson_yyjson_arr_iter_next(yyjson_arr_iter* iter) {
...
yyjson_val* __sn_wrap_lib_yyjson_yyjson_obj_iter_next(yyjson_obj_iter* iter) {
  return yyjson_obj_iter_next(iter);
}


yyjson_val* __sn_wrap_lib_yyjson_yyjson_obj_iter_get_val(yyjson_val* key) {
...
bool __sn_wrap_lib_yyjson_yyjson_get_bool(yyjson_val* val) {
  return yyjson_get_bool(val);
}

double __sn_wrap_lib_yyjson_yyjson_get_num(yyjson_val* val) {
...
yyjson_val* __sn_wrap_lib_yyjson_yyjson_arr_get(yyjson_val* arr, size_t idx) {
  return yyjson_arr_get(arr, idx);
}

size_t __sn_wrap_lib_yyjson_yyjson_arr_size(yyjson_val* arr) {
...
size_t __sn_wrap_lib_yyjson_yyjson_obj_size(yyjson_val* obj) {
...
void __sn_wrap_lib_yyjson_yyjson_doc_free(yyjson_doc* doc) {
  yyjson_doc_free(doc);
}
